...
<g>
  ...
  class="st0" d="M179.335,226.703c22.109,0.219,37.484,21.172,44.047,27.047c1.578,1.828,3.875,2.984,6.469,2.984
  ...
  <motion.path 
                  ...
                  initial="hidden"
                  animate="visible"
  class="st0" d="M331.554,216.813c-35.188,0-50.734,20.875-55.734,25.656l0.016,0.047c-1.906,1.578-3.125,3.922-3.125,6.594
  ...
  <motion.path 
                  ...
                  initial="hidden"
                  animate="visible"
  class="st0" d="M331.054,370.563l-36.141-2.063l-17.172-10.781c0,0-10.031,5.922-12.328,7.297h-9.094h-9.094
  ...
  < motion.path 
                  ...
                  initial="hidden"
                  animate="visible"
  class="st0" d="M181.772,319.344c20.031,0,32.766-16.594,32.766-22.219s-12.734-22.203-32.766-22.203
    s-32.781,16.578-32.781,22.203S161.741,319.344,181.772,319.344z"/>
  <motion.path 
                  variants={pathVariants}
                  initial="hidden"
                  animate="visible"
  class="st0" d="M325.335,319.344c20.031,0,32.781-16.594,32.781-22.219s-12.75-22.203-32.781-22.203
    s-32.766,16.578-32.766,22.203S305.304,319.344,325.335,319.344z"/>
  <motion.path 
                  variants={pathVariants}
                  initial="hidden"
                  animate="visible"
  class="st0" d="M482.46,167.234l-88.891-22.219c0,0-11-76.734-12.781-89.219c-1.766-12.453-12.484-46.344-51.703-46.344
